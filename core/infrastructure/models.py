...
class StatusGEDModel(models.Model):
    ...
    descricao = models.CharField(max_length=255, blank=True)
    pagamento = models.CharField(max_length=100, blank=True)
    cod_ativacao = models.CharField(max_length=50)
    cod_plano = models.CharField(max_length=50)
    plano = models.CharField(max_length=255)
    vendedor = models.CharField(max_length=255)
    local = models.CharField(max_length=100)
    cliente = models.CharField(max_length=255)
    protocolo_ged = models.CharField(max_length=100)
    status_ged = models.CharField(max_length=20)
    data_ged = models.DateField(null=True, blank=True)
    data_digitalizacao = models.DateTimeField(null=True, blank=True)
    ...
    cpf_ged = models.CharField(max_length=20)
    ntc_ged = models.CharField(max_length=50)
    plano_completo = models.CharField(max_length=255)
    primario = models.CharField(max_length=100)
    secundario = models.CharField(max_length=100)
    cpf = models.CharField(max_length=20)
    pessoa_tipo = models.CharField(max_length=2)
    plano_g = models.CharField(max_length=255)
    cadastro_geral = models.IntegerField(null=True, blank=True)
    codplanod = models.IntegerField(null=True, blank=True)
    codplanoc = models.IntegerField(null=True, blank=True)
    codplanocddd = models.IntegerField(null=True, blank=True)
    codplanoddd = models.IntegerField(null=True, blank=True)
    cod_combo = models.CharField(max_length=50)
    sinalizacao = models.CharField(max_length=50)
    id_plano = models.IntegerField(null=True, blank=True)
    preco_pre = models.DecimalField(max_digits=10, decimal_places=2)
    preco_tabela = models.DecimalField(max_digits=10, decimal_places=2)
    portabilidade = models.CharField(max_length=5)
    parcelas = models.IntegerField()
    plano_cg_titular = models.CharField(max_length=255)
    dependente = models.CharField(max_length=100)
    plano_titular = models.CharField(max_length=255)
    ignorar = models.CharField(max_length=5)
    id_ged_final = models.IntegerField(null=True, blank=True)
    desc_ativacao = models.CharField(max_length=255)
    desc_combo = models.CharField(max_length=255, blank=True)
    ntc_provisorio = models.CharField(max_length=50, blank=True)
    smp = models.CharField(max_length=10)
    seguro = models.CharField(max_length=100)
    cod_local = models.IntegerField(null=True, blank=True)
